...
public static class BlockBehaviourData
{
	...
	public static void initializeHashtables()
	{
		digBehaviours = new Hashtable() { // hashtable that holds the class for the different block sounds and speed when breaking them
			...
			{ "TulipOrange", new BreakInstantly() },
			{ "TulipPink", new BreakInstantly() },
			{ "TulipRed", new BreakInstantly() },
			{ "TulipWhite", new BreakInstantly() },
			...
			{ "DoorCherryTopLeft", new BreakWood() },
			{ "DoorCherryTopRight", new BreakWood() },
			{ "DoorCherryBottomLeft", new BreakWood() },
			{ "DoorCherryBottomRight", new BreakWood() },
			{ "DoorCherryTopSideLeft", new BreakWood() },
			{ "DoorCherryTopSideRight", new BreakWood() },
			{ "DoorCherryBottomSideLeft", new BreakWood() },
			{ "DoorCherryBottomSideRight", new BreakWood() },
		...
		itemDropBehaviours = new Hashtable()
		{
			...
			{ "LeavesCherry", new LeafItemDrop("Cherry") },
			...
			{ "DoorCherryTopLeft", new DoorDrop(false, "Cherry") },
			{ "DoorCherryTopRight", new DoorDrop(false, "Cherry") },
			{ "DoorCherryBottomLeft", new DoorDrop(true, "Cherry") },
			{ "DoorCherryBottomRight", new DoorDrop(true, "Cherry") },
			{ "DoorCherryTopSideLeft", new DoorDrop(false, "Cherry") },
			{ "DoorCherryTopSideRight", new DoorDrop(false, "Cherry") },
			{ "DoorCherryBottomSideLeft", new DoorDrop(true, "Cherry") },
			{ "DoorCherryBottomSideRight", new DoorDrop(true, "Cherry") },
		...
		blockToStepSoundFolder = new Hashtable()
		{
			...
			{ "LogCherry", new object[]{ "wood", 6 }},
			{ "PlankOak", new object[]{ "wood", 6 }},
			{ "PlankSpruce", new object[]{ "wood", 6 }},
			{ "PlankCherry", new object[]{ "wood", 6 }},
